    ...
    <div class="md-header__title" data-md-component="header-title">
      <div class="md-header__ellipsis">
        <div class="md-header__topic" style="font-weight:500">
          ...
          <style>
            /* mkdocs-material 9.7.6 no longer sets position:relative on
               .md-version, so the absolutely-positioned list anchored to a
               wide ancestor and the old "margin-top: 20%" hack dropped it
               into the page. Re-anchor it directly under the version button. */
            .md-version { position: relative; }
            .md-version:focus-within .md-version__list, .md-version:hover .md-version__list {
              ...
              <div class="md-version">
                ...
                <ul class="md-version__list" style="margin-top: 2.2rem;">
