---
title: KDB-X Python Real-Time Data Capture
description: Introduction to the KDB-X Python Real-Time Data Capture functionality 
date: July 2024
author: KX Systems, Inc.,
tags: KDB-X Python, q, streaming, publishing, real-time data
---


# Real-Time Data Capture

_This page is an introduction to the KDB-X Python Real-Time Data Capture functionality._ 
...
Below we're breaking down the documentation sections to guide you through the process of generating these systems using KDB-X Python and what to consider while building up your infrastructure.
...
|7. |[Complex streaming control](complex.md) |Learn how to further edit/manage your streaming workflows with KDB-X Python. Methods include: fine-grained ingest control, process logs and stopping processed. |
