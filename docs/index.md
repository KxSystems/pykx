...
<div class="large-tile-grid home-offerings">
    ...
    <div>
        ...
        <ul>
            ...
            <li><a href="learn/objects.html" target="_blank" rel="noopener">Objects and Attributes</a></li>
            <li><a href="user-guide/advanced/database/index.html">Databases</a></li>
        </ul>
    </div>
    <div>
        <h2>How-to Guides</h2>
    ...
    <div>
        <h2>Reference</h2>
        <ul>
            <li><a href="api/pykx-execution/q.html" target="_blank" rel="noopener">API References</a></li>
            <li><a href="api/pykx-q-data/toq.html" target="_blank" rel="noopener">Data Types and Conversions</a></li>
            <li><a href="user-guide/advanced/Pandas_API.html" target="_blank" rel="noopener">Pandas Like API</a></li>
        </ul>
    </div>
    <div>
        <h2>Integrations</h2>
        <ul>
            <li><a href="user-guide/advanced/numpy.html" target="_blank" rel="noopener">NumPy</a></li>
            <li><a href="user-guide/advanced/streamlit.html" target="_blank" rel="noopener">Streamlit</a></li>
            <li><a href="examples/charting.html" target="_blank" rel="noopener">Python Charting Libraries</a></li>
        </ul>
    </div>
        <div>
        <h2>Examples</h2>
